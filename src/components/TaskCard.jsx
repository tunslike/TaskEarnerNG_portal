...
const TaskCard = ({img, title, taskid, thumbnail, icon, desc, earning}) => {
  ...
  return (
    <div>
        <div onClick={openModal} className='task-card'>
            <img src={img} />
            <div>
                <h1>{title}</h1>
                ...
                {desc == '' ? 
                  ...
                  <p><TruncatedText text={desc} maxLength={90} /></p>
                }
               ...
               
                {
                  ...
                  <div className='flex items-center gap-2 mt-4'>
                    ...
                    <h4 className='bg-primaryOrange text-[0.8rem] px-4 py-1 text-white font-[500] rounded-[1rem]'>₦ {earning}</h4>
                  </div>
                }
        ...
        >
              ...
              <h1 className='text-[0.9rem] ml-6 font-[500]'>Earnings: <span className='bg-primaryOrange text-white rounded-[1rem] px-3 py-[2px]'>₦ {earning}</span> </h1>
              <Link
                to="/complete-task" state={{taskId: taskid}}
